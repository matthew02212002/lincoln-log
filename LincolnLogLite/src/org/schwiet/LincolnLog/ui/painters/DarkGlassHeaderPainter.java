 ...
 */
public class DarkGlassHeaderPainter implements Painter<Component>{
    /*
     * colors
     */
    private final Color MID_LOW = new Color(20, 20, 20);
    private final Color TOP = new Color(45, 45, 45);
    private final Color MID_TOP = new Color(25, 25, 25);
    private final Color BTM = new Color(10, 10, 10);
    /*
     * gradient stuff
     */
    ...
    private final Color[] MINOR_COLORS = {new Color(60,60,60), new Color(30, 35, 48)};
    //
    ...
    public void paint(Graphics2D graphics, Component objectToPaint, int width, int height) {
        ...
        graphics.fillRect(0, 1, width, height-2);
        /*
         * this goes in front
         */
        graphics.setPaint(fill);
        graphics.fillRect(1, 2, width-2, height-4);
        /*
         * finally
         */
