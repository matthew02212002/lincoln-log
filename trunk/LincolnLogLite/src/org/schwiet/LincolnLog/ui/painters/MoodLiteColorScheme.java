 ...
 */
public class MoodLiteColorScheme implements BasicThemedColorScheme{
    private final Color BGRND = new Color(40,40,40);
    private final Color FGRND = new Color(245, 250, 255);
