...
public class TransFormPainter implements Painter<Component> {
    ...
    private static final float[] STOPS = {0.0f, 1.0f},
            CURVE_STOPS = {0.0f, 0.4f, .7f, 1.0f},
            CURVE_STOPS2 = {0.0f, .5f, .75f, 1.0f};
    /*
     *
     */
    private static final Color[] COLORS = {CENTER, OUTER},
            CURVE_COLORS = {CURVE_LITE, CURVE_MID, CURVE_LITE, CURVE_DARK},
            CURVE_COLORS2 = {CURVE_MID, CURVE_LITE, CURVE_MID, CURVE_LITE},
            RAD_COLORS = {RAD_CENTER, RAD_OUTER};
    /*
     *
     */
    ...
    public void paint(Graphics2D graphics, Component objectToPaint, int width, int height) {
        //prevent recreating gradients when unnecessary
        if (gradient == null
                || curve_shadow == null
                || curve_shine == null
                || cachedWidth != width
