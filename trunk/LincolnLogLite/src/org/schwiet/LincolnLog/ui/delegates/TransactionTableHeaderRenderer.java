...
public class TransactionTableHeaderRenderer extends JLabel implements TableCellRenderer{
    ...
    public TransactionTableHeaderRenderer(JTable table){
        tableRef = table;
        this.setUI(new IndentLabelUI(IndentDirection.UP));//, new Color(220,220,220), Color.GRAY,new Color(20,20,20)));
...
//            setHorizontalAlignment(SwingConstants.LEFT);
        ...
        fColumnModelIndexBeingPainted = 0 <= column && column < tableRef.getColumnCount()
                ? tableRef.convertColumnIndexToModel(column) : -1;
